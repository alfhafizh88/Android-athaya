...
if(isset($_POST['simpan'])) {
    ...
    $kueri="UPDATE tanah set status='1' WHERE id_tanah='".$_POST['id_tanah']."'";
                        ...
                        <div class="body">
                            ...
                            echo'<form action="" method="POST">
                             ...
                             <div style="position: absolute; top: 350px;">
                                <input type="submit" name="ubah" value="Menyetujui" class="btn btn-success waves-effect">     
                            ...
                            <?php
                            if ($sisa>0) {
                                echo '<div style="position: absolute; top: 330px; right: 60px"><br><a href="transaksi.php?id='.$row['id_tanah'].'" class="btn bg-red waves-effect" style="width: 100%;">Transaksi</a></div>';
                            } else {
                            ...
                            ?>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td><b>Nama Pemilik Akun</b></td>
                                        <td class="tab">:</td>
                                        <td><?php  
                                         echo "<a href='#' data-toggle='modal' data-target='#smallModal2'>".$row['akun_pemilik']."</a>";   
                                        ?></td>
                                    </tr>
                                    <?php
                                    if (empty($row['username'])) {
                                        ...
                                        <?php
                                        $sql9="SELECT * FROM akun 
                                where username='".$row['akun_pemilik']."'";
                            ...
                            echo '
                                ...
                                ';
                                 ...
                                 FROM mutasi2 m join tanah t on m.dulu=t.id_tanah 
                                                join tanah tt on m.skrg=tt.id_tanah
                                                join satuan s on t.id_satuan=s.id_satuan
                                 WHERE tt.gol=105 order by tanggal_regis asc"; 
                                  ...
                                  <h4>Riwayat Penjualan / Hibah / Waris<p style="color: red">(Keseluruhan)</p></h4><br>
                                    <form action="laporan_tanah_cetak2.php" method="POST" id="form-delete">
                                        ...
                                        <button type="button" class="btn btn-success waves-effect" value="Cetak (PDF)" id="btn-delete" style="left: 800px;"><i class="material-icons">print</i> Cetak</button><br>
