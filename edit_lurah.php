...
session_start();
 include("conn.php");
        if(isset($_POST['submit'])){
            $sql="UPDATE lurah set nama_lurah='".$_POST['nama']."', id_jabatan='".$_POST['jabatan']."', 
            tgl_masuk='".$_POST['tgl_masuk']."', tgl_keluar='".$_POST['tgl_keluar']."', ket='".$_POST['ket']."' 
            WHERE nip='".$_POST['nip2']."'";
...
<body class="theme-red">
    ...
    <h2>
        <ol class="breadcrumb breadcrumb-col-pink">
                    ...
                    <li><a href="d_lurah.php">Data Lurah</a></li>
                    <li class="active">Edit Data Lurah</li>
        </ol>
    </h2>
</div>
<!-- Exportable Table -->
        ...
        <div class="card">
            <div class="header">
                <h2 style="font-style: 90px">
                    <i class="material-icons">collections_bookmark</i>  Edit Data Lurah
                </h2>
...
include("conn.php");
$id=$_GET['key'];
$sql="SELECT * FROM lurah WHERE nip='".$id."'";
    $rs=mysqli_query($conn,$sql);
    if($rs){
        $row=mysqli_fetch_assoc($rs);
    }else echo "NIP Salah";
?>
                <form id="form_validation" action="edit_lurah.php" method="POST">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="nip2" value="<?php echo $row['nip']?>" readonly='true' required>
                            <label class="form-label" style="color: black; font-weight: bold;">NIP</label>
                        </div>
                    </div>    
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $row['nama_lurah']?>" required>
                            <label class="form-label" style="color: black; font-weight: bold;">Nama Lurah</label>
                        </div>
                    </div>    
                     <label class="form-label"><p style="color: black; font-size: 12px; font-style: arial; font-weight: bold;">Jabatan</p></label><br>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="date" class="form-control" name="tgl_masuk"  value="<?php echo $row['tgl_masuk']?>" required>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="ket" value="<?php echo $row['ket']?>" required>
