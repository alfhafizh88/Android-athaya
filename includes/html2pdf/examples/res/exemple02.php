...
<page style="font-size: 10pt">
    ...
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
			...
			<td><div>Membimbing siswa / siswi Praktek Kerja Industri Program Keahlian Teknik Informasi dan Komunikasi, Jurusan / Kompetensi Keahlian Rekayasa Perangkat Lunak.</div></td>
        </tr>
    </table>
    <br>
