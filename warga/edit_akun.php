...
session_start();
 include("conn.php");
        if(isset($_POST['submit'])){
            $sql="UPDATE akun set nama_akun='".$_POST['nama']."', email='".$_POST['email']."', alamat='".$_POST['alamat']."', telepon='".$_POST['telepon']."' , level='".$_POST['level']."'
...
<body class="theme-red">
    ...
    <h2>
        <ol class="breadcrumb breadcrumb-col-pink">
                    ...
                    <li><a href="d_akun.php">Data Akun</a></li>
        ...
        <div class="card">
            <div class="header">
                <h2 style="font-style: 90px">
                    <i class="material-icons">collections_bookmark</i>  Edit Data Akun
                </h2>
...
?>
                <form id="form_validation" action="edit_akun.php" method="POST">
                    <input type="hidden" name="kode" value="<?php echo $row['username']?>">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="nama" value="<?php echo $row['nama_akun']?>" required>
