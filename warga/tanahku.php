...
<div class="block-header">
   ...
   $nquery2=mysqli_query($conn,"SELECT  id_tanah, persil, kohir, nama_kelas, nama_kelas, nama_lengkap, luas, tgl_regis, nama_satuan, induk
    ...
    WHERE $kategoriobat LIKE '$search' AND status='1' AND akun_pemilik='".$_SESSION['namauser']."' ORDER BY tgl_regis");
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                $number=1;
                                 ...
                                 WHERE dulu=$hasil[id_tanah] and tt.status='1'"; 
                    ...
                    <div class="card">
                        <div class="header">
                            <h2 style="font-style: 90px">
                                ...
                                <i class="material-icons">library_books</i> Tanah Saya
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="form_validation" method="POST" action="../tanah_proses.php" enctype="multipart/form-data" >
                                ...
                                <input type="hidden" class="form-control" name="akun"  value="<?php echo $_SESSION['namauser']?>" required>
                                <div class="form-group form-float">
                                    <div class="form-line">
...
if ($baris2=mysqli_num_rows($nquery)) {
    # code...
...
';
    ...
    echo '<div class="alert alert-danger alert-dismissible" role="alert">
                                ...
                                <center>Anda tidak memiliki daftar riwayat tanah!</center>
                            </div>
                            ';
}
