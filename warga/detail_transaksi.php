...
<div class="block-header">
                <h2>
                    <ol class="breadcrumb breadcrumb-col-pink">
                                ...
                                <li class="active">Detail Tanah</li>
                    </ol>
                </h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <?php
                            if ($sisa>0) {
                                echo '<br><div style="position: absolute; width:70%"><br><a href="transaksi.php?id='.$row['id_tanah'].'" class="btn bg-red waves-effect" style="width: 100%;">Transaksi</a></div>';
                            } else {
                        ...
                        <div class="modal-footer">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                $number=1;
                                 ...
                                 WHERE dulu=$row[id_tanah] and tt.status='1'"; 
