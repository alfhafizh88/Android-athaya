        ...
        <div class="card">
            <div class="header">
                <h2 style="font-style: 90px">
                    <i class="material-icons">collections_bookmark</i> Notifikasi
                 &nbsp;&nbsp;
                </h2>
...
<div id="area_tanah">
                <div class="table-responsive">
                        ...
                        <?php
                            $query="SELECT  * 
                                    FROM tanah WHERE akun_pemilik='".$_SESSION['namauser']."'";
                                    $hasil = mysqli_query($conn, $query);   
                                    //print_r($hasil);
                        echo '
                        ...
                        while($baris = mysqli_fetch_array($hasil)) {
                            ...
                            <tr>
                                ...
                                <?php
                                    if ($baris['status']=='0') {
                                    echo '
                                       <td> <span class="label bg-orange">Proses Persetujuan</span></td>
                                    ';
                                    } elseif($baris['status']=='1'){
                                        echo '
                                            <td><span class="label bg-green">Telah disetujui</span></td>
                                        ';
                                    ...
                                    <?php
                                    echo'
                                <td><a href="edit_dalam.php?id='.$baris[0].'" class="btn bg-green btn-block btn-xs waves-effect">Detail</a> ';
