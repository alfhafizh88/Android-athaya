...
if(isset($_POST['simpan'])) {
    ...
    $query="INSERT into jabatan values ('', '".$_POST['nama']."', 'Aktif', '".$_POST['ket']."')";
    ...
    if($hasil /*&& $hasil2*/) {
        ...
        echo '<script type="text/javascript">
                ...
                window.location.href = "d_jabatan.php";
             </script>';
    }
}else if (isset($_POST['ubah'])) {
      $sql="UPDATE jabatan set nama_jab='".$_POST['nama']."', ket='".$_POST['ket']."', status='".$_POST['status']."'
            WHERE id_jabatan='".$_POST['kode']."'";
                    ...
                    <div class="card">
                        <div class="header">
                            <h2 style="font-style: 90px">
                                ...
                                <i class="material-icons">recent_actors</i>  Data Jabatan
                             &nbsp;&nbsp;<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  -->
                             <?php 
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="d_jabatan.php">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nama" required>
                                        <label class="form-label" style="color: black; font-weight: bold;">Nama Jabatan</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
	    ...
	    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
	      <thead>
	        ...
	        <tbody>
                ...
                while($baris = mysqli_fetch_array($hasil)) {
		        	echo'
		        		<tr>
                            ...
                            <td>'.$baris['ket'].'</td>
			                <td>                          
                            <button type="button" data-toggle="modal" data-target="#'.$baris['id_jabatan'].'" class="btn btn-primary waves-effect" name="simpan2" data-toggle="tooltip" data-placement="right" title="Edit Jabatan"><i class="material-icons">edit</i>
                            </button>


                            <div class="modal fade" id="'.$baris['id_jabatan'].'" tabindex="-1" role="dialog">
                ...
                <form id="form_validation" action="d_jabatan.php" method="POST">


                    
                    <div class="form-group form-float">
                        <input type="hidden" name="kode" id="kode" value="'.$baris['id_jabatan'].'" required>
                        <br>
                        <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="nama" id="nama_kelas" value="'.$baris['nama_jab'].'" required>
