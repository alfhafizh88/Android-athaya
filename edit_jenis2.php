...
session_start();
 include("conn.php");
        if(isset($_POST['submit'])){
            $sql="UPDATE jenis_jualbeli set id_transaksi='".$_POST['jenis']."', jenis_jb='".$_POST['nama']."' 
            WHERE id_jb='".$_POST['kode']."'";
...
<body class="theme-red">
    ...
    <h2>
        <ol class="breadcrumb breadcrumb-col-pink">
                    ...
                    <li><a href="d_jenis.php">Data Jenis</a></li>
                    <li class="active">Edit Data Sub Jenis</li>
        </ol>
    </h2>
</div>
<!-- Exportable Table -->
        ...
        <div class="card">
            <div class="header">
                <h2 style="font-style: 90px">
                    <i class="material-icons">collections_bookmark</i>  Edit Data Sub Jenis
                </h2>
...
include("conn.php");
$id=$_GET['key'];
$sql="SELECT * FROM jenis_jualbeli WHERE id_jb='".$id."'";
    $rs=mysqli_query($conn,$sql);
    if($rs){
        $row=mysqli_fetch_assoc($rs);
    }else echo "ID jenis Salah";
?>
                <form id="form_validation" action="edit_jenis2.php" method="POST">
                    <input type="hidden" name="kode" value="<?php echo $row['id_jb']?>">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="nama" value="<?php echo $row['jenis_jb']?>" required>
                            <label class="form-label" style="color: black; font-weight: bold;">Nama jenis</label>
                        </div>
                    </div>    
                    <input type="submit" name="submit" value="Ubah" class="btn bg-blue waves-effect" />
                </form>
